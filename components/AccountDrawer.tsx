...
export function AccountDrawer() {
  ...
  return (
    <SiteDrawer id="account" title="Account">
      {session ? (
        <div className="account-drawer__body">
          ...
          <p className="account-drawer__lede">
            Signed in as {session.email}. Your details stay with you here.
          </p>
        ...
        <div className="account-drawer__body">
          ...
          <p className="account-drawer__note">
            Be first to the edition. Complimentary tracked shipping in the US.
          </p>
        </div>
      )}
    </SiteDrawer>
